 ...
 * </p>
 * <ul>
 *   <li>{@link springModelMof.impl.PrimitiveTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveTypeImpl extends TypeImpl implements PrimitiveType {
	 ...
	 * @ordered
	 */
	protected static final TypesEnum TYPE_EDEFAULT = TypesEnum.STRING;
	...
	protected EClass eStaticClass() {
		return SpringModelMofPackage.Literals.PRIMITIVE_TYPE;
	}
	...
	public void setType(TypesEnum newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringModelMofPackage.PRIMITIVE_TYPE__TYPE, oldType,
					type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SpringModelMofPackage.PRIMITIVE_TYPE__TYPE:
			return getType();
		}
