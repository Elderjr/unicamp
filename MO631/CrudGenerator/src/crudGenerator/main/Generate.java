...
public class Generate extends AbstractAcceleoGenerator {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/crudGenerator/main/generate";
	 ...
	 *            located.
	 * @param targetFolder
	 *            This will be used as the output folder for this generation : it
	 *            will be the base path against which all file block URLs will be
	 *            resolved.
	 * @param arguments
	 ...
	 *            argument taken from the model, pass them here.
	 * @throws IOException
	 *             This can be thrown in two scenarios : the module cannot be found,
	 ...
	 * @throws IOException
	 *             This will be thrown if any of the output files cannot be saved to
	 *             disk.
	 * @generated
	 */
	@Override
	...
	public void registerPackages(ResourceSet resourceSet) {
		...
		if (!isInWorkspace(SpringModelMofPackage.class)) {
			resourceSet.getPackageRegistry().put(SpringModelMofPackage.eNS_URI, SpringModelMofPackage.eINSTANCE);
		}
